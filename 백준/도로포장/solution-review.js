/**
 * [solution]
 * - 1번 노드에서 N번 노드중 갈 수 있는 최단거리를 구하는 문제
 * - 하지만, 최단거리 간선들 중에 하나를 시간 0으로 만들어서 갈 수 있는 최단시간을 구해야한다.
 * - 다익스트라로 최단거리를 구하면서, 동시에 해당 간선을 포장했을 때의 시간도 함께 dp로 구한다.
 */
...
const distance = Array.from(Array(n + 1), () => new Array(k + 1).fill(Infinity));
